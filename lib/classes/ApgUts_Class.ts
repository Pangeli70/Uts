 ...
 * @version 0.9.1 [APG 2024/08/26] 
 * @version 0.9.2 [APG 2024/09/21] loggable events
 * @version 0.9.3 [APG 2024/11/02] cleanup and alignment with ApgUts_Service
...
import { ApgUts_Result } from "./ApgUts_Result.ts";
